...
<?php 
  ...
  $year = mysqli_query($conn, "SELECT * FROM schoolyear WHERE status='Active'");
 ...
 <!-- Page Content  -->
    ...
    <div class="table-responsive p-4 ">
      ...
      <table class="table table-bordered table-striped table-hover table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl table-responsive-xxl " id="exasmple">
        <thead>
          <tr>
            <!-- <th>Semester</th> -->
            <th>Subject code</th>
        ...
        <tbody>
          <?php
            $query ="SELECT * FROM student_grade JOIN student ON student_grade.student_id=student.Id JOIN subject ON student_grade.subject_id=subject.sub_Id JOIN semester ON subject.semester_id=semester.Id WHERE Semester.Semester='1st Semester'";
