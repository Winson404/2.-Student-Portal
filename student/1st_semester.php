 ...
 <!-- Page Content  -->
      <div id="content" class="p-4 p-md-5 pt-5">
        <div class="card p-3">
          <h4 class="bg-light p-3" align="center"><strong>1st Semester</strong></h4>  
    ...
    <div class="table-responsive p-4">
      ...
      <table class="table table-bordered table-striped table-hover table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl table-responsive-xxl" id="example">
        ...
        <tbody>
          <?php
            $query ="SELECT * FROM semester JOIN schoolyear ON semester.school_id=schoolyear.Id WHERE Semester='1st Semester'";
