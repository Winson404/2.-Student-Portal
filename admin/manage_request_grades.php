 ...
 <!-- Page Content  -->
      <div id="content" class="p-4 p-md-5 pt-5">
        <div class="card p-3">
          <h4 class="bg-light p-3" align="center"><strong>Manage grade requests</strong></h4>  
          <div class="table-responsive p-4">
            ...
            <table class="table table-bordered table-dark table-striped table-hover table-responsive-sm " id="example">
              ...
              <tbody>
                <?php
                    include("../config.php");
                    $query ="SELECT * FROM request_grade JOIN student ON request_grade.student_Id=student.Id AND request_grade_status='Pending'";
                ...
                <tr>
                    ...
                    <td><?php echo $row["grade_date_requested"];?></td>
                    <td>
                        <button class="btn btn-success" data-bs-toggle="modal" type="button" data-bs-target="#approve_grade<?php echo $row['request_grade_Id']; ?>"><i class="bi bi-check2-circle"></i> Confirm</button>
                        <a target="_blank" href="generate_grades_form.php?Id=<?php echo $row['Id'] ?>" class="btn btn-primary"><i class="bi bi-file-text"></i> Generate form</a>
                       <!--  <button class="btn btn-primary" data-bs-toggle="modal" type="button" data-bs-target="#deletelevel_modal<?php echo $row['Id']; ?>"></button> -->
                    </td>                
                </tr>
                <?php 
                  include 'manage_approve_grade.php';
                     }  
                ?> 
              </tbody>
            </table>
