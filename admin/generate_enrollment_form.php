...
<body>
  ...
  <div id="printElement" >
      <div class="col-lg-12" >
          ...
          <div class="mt-2">
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that Mr. <b><?php echo $row1['firstname']; echo ' '; echo $row1['middlename']; echo ' '; echo $row1['lastname'];?></b>, a <b><?php echo $row1['level']; echo ' '; echo $row1['section']; ?> </b> of the course <b><?php echo $row1['dept_name'];?></b> of this Institution was officially enrolled in the subjects listed below with their corresponding grade(s) and unit(s).</p>
          </div>
