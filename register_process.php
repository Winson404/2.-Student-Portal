	            	...
	            	header("Location: register.php");
				        ...
				        $uploadOk = 0;
			                ...
			                // if everything is ok, try to upload file
			                    ...
			                    $sql = " INSERT INTO student (id_no, firstname, middlename, lastname, dob, age, email, contact, address, username, password, images, dept_id, year_level) VALUES ('NLP-$id_no', '$firstname', '$middlename', '$lastname', '$dob', '$age', '$email', '$contact', '$address', '$username', '$password', '$file', '$department', '$year_level')";
